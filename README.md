# Learn JAMstack Serverless in Baby Steps using Gatsby.js, React, Contentful, Storybook, Netlify, FaunaDB, Firebase, Algolia, GitHub Actions, Project Fugu, and CSS Houdini
